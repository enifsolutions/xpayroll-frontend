...
// ── Quick-access items shown when palette opens with no query ─────────────────
const quickAccess = [
  'dashboard',
  'employees-list',
  'leave-requests',
...
const quickItems = searchIndex.filter(i => quickAccess.includes(i.id))
          ...
          >
              ...
              {displayItems.map((item, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isActive && (
                      <ArrowRight size={14} className="flex-shrink-0 text-violet-500" />
                    )}
                  </div>
                )
              })}
            ...
            <div className="flex items-center gap-4 px-4 py-2.5 border-t border-gray-100 dark:border-gray-800 text-[11px] text-gray-400">
              <span className="flex items-center gap-1">
                <kbd className="px-1 rounded border border-gray-200 dark:border-gray-700 font-mono">↑↓</kbd> navigate
              </span>
              <span className="flex items-center gap-1">
                <kbd className="px-1 rounded border border-gray-200 dark:border-gray-700 font-mono">↵</kbd> go
              </span>
              <span className="flex items-center gap-1">
                <kbd className="px-1 rounded border border-gray-200 dark:border-gray-700 font-mono">esc</kbd> close
              </span>
