    ...
    switch (confirmAction) {
      ...
      case "RESUME":
        return {
          ...
          message: `${code} will start accepting applications again.`,
          danger: false,
        };
      case "CLOSE":
        return {
                      ...
                      <td>
                        <div className="flex items-center justify-end gap-1">
                          <button
                            ...
                            title="Skills, education and certifications"
                          >
                          ...
                          <button
                            onClick={() =>
                              router.push(
                                `/recruitment/postings?requisitionId=${r.id}`,
                              )
                            }
                          ...
                          {canManage && r.status === "OnHold" && (
                            <button
                              onClick={() => askConfirm(r, "RESUME")}
                              className="p-1.5 rounded-lg hover:bg-emerald-50 dark:hover:bg-emerald-900/20 text-emerald-500 transition-colors"
