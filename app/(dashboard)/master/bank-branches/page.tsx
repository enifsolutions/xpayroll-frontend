...
import { BANK_BRANCHERS_STEPS } from "@/lib/tours/bank-branches";
...
export default function BankBranchesPage() {
  const tour = useTour("admin-page-bank-branches", BANK_BRANCHERS_STEPS);
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Manage bank branch master data for payroll processing.
          </p>
        </div>
        {canManage && (
          <Button
            variant="solid"
            data-tour="bank-branches-add-button"
      ...
      <div className="card">
        <div className="card-body">
          ...
          <div
            ...
            data-tour="bank-branches-filter-row"
          >
          ...
          {loading ? (
            ...
            <>
              <table
                ...
                data-tour="bank-branches-table-card"
              >
                <thead>
                  <tr>
                    <th>Bank</th>
                      ...
                      <tr key={item.id}>
                        <td>
                          <div className="flex items-center gap-3">
                            <div
                              className={`${bankColor(item.bankName)} w-8 h-8 rounded-lg flex items-center justify-center text-white text-xs font-bold flex-shrink-0`}
                            >
      ...
      <ConfirmDialog
        ...
        message={
          deleteTarget
            ? `Remove "${deleteTarget.branchName}" from ${deleteTarget.bankName}?`
            : ""
        }
