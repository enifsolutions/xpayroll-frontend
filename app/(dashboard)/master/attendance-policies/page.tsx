                ...
                {items.length === 0 ? (
                  ...
                  items.map((item) => (
                    <tr key={item.id}>
                      ...
                      <td>
                        <span
                          className={`xp-badge ${item.allowSelfCheckin ? "xp-badge-success" : "xp-badge-neutral"}`}
                        >
                      ...
                      <td>
                        <span
                          className={`xp-badge ${item.allowBiometric ? "xp-badge-success" : "xp-badge-neutral"}`}
                        >
                      ...
                      <td>
                        <span
                          className={`xp-badge ${item.allowQrNfc ? "xp-badge-success" : "xp-badge-neutral"}`}
                        >
