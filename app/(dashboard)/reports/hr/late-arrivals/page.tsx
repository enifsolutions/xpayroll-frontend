...
const COLS = [
  ...
  { header: "Date",       field: "workDate" },
  { header: "Check In",   field: "checkIn" },
  { header: "Late (min)", field: "lateMinutes", align: "right" as const, format: "number" as const },
  { header: "Shift",      field: "shiftName" },
];

export default function LateArrivalsPage() {
  usePermission("Reports.LateArrivals.View");
  ...
  return (
    <ReportPage
      ...
      description="Employees who arrived late within the selected date range"
